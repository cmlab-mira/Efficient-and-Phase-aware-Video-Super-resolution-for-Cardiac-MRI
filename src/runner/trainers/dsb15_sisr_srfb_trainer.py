...
from src.runner.trainers import Dsb15SISRTrainer


class Dsb15SISRSRFBTrainer(Dsb15SISRTrainer):
    """The DSB15 trainer for the Single-Image Super-Resolution using the SRFBNet.
    """
