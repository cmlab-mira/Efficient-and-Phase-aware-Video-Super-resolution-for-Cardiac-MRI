...
from src.runner.predictors import Dsb15SISRPredictor


class Dsb15SISRSRFBPredictor(Dsb15SISRPredictor):
    """The DSB15 predictor for the Single-Image Super-Resolution using the SRFBNet.
    """
